...
class UI {
  ...
  imprimirCitas() {
    ...
    // Leer el contenido de la base de dato s

    const objecStore = DB.transaction("citas").objectStore("citas");

    const fnTextoHeading = this.textoHeading;

    const total = objecStore.count();
...
function nuevaCita(e) {
  ...
  if (editando) {
    ...
    const objecStore = transaction.objectStore("citas");
    ...
    // Mostrar mensaje de que todo se agrego correctamente

    ui.imprimirAlerta("Se agrego correctamente en la base de datos ");
